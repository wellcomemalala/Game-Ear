...
export const MusicPracticeIcon: React.FC<IconProps> = ({ className }) => (
  <svg 
  ...
  >
    ...
    <path d="M3.5 10a.5.5 0 000 1H17a.5.5 0 000-1H3.5z" opacity="0.3" />
    <path d="M3.5 12a.5.5 0 000 1H17a.5.5 0 000-1H3.5z" opacity="0.3" />
    <path d="M3.5 8a.5.5 0 000 1H17a.5.5 0 000-1H3.5z" opacity="0.3" />
