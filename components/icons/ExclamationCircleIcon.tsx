...
export const ExclamationCircleIcon: React.FC<IconProps> = ({ className, title }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 20 20" 
    fill="currentColor" 
    className={className || "w-5 h-5"}
    aria-labelledby={title ? "exclamation-title" : undefined}
  >
    {title && <title id="exclamation-title">{title}</title>}
