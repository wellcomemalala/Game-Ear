...
import { PlayerData, IntervalInfo, ChordInfo, UnlockedItemType, ThaiUIText, PetAbilityType } from '../../types';
...
const UnlockablesStore: React.FC<UnlockablesStoreProps> = ({
  ...
  const calculateFinalCost = (baseCost: number): number => {
    const discountMultiplier = getActivePetAbilityMultiplier(PetAbilityType.GCOIN_DISCOUNT_UNLOCKABLES);
